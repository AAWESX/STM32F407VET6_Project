...
// 计算一毫秒需要的循环次数（这只是一个粗略的估计，可能需要根据实际情况调整）  
#define MS_DELAY_LOOP_COUNT_MS (SYSTEM_CLOCK_FREQ / 9000UL)  // 8000 HZ
#define MS_DELAY_LOOP_COUNT_US (SYSTEM_CLOCK_FREQ / 9000000UL)  //8HZ
