...
8位Data FSMC_A(n)(寄存器/数据选择)脚
FSMC_A0 NULL(8位 无A0)
FSMC_A1  = FSMC_Bank1_NORSRAM(n) + (1 << 1)
FSMC_A2  = FSMC_Bank1_NORSRAM(n) + (1 << 2)
FSMC_A3  = FSMC_Bank1_NORSRAM(n) + (1 << 3) 
FSMC_A4  = FSMC_Bank1_NORSRAM(n) + (1 << 4)
FSMC_A5  = FSMC_Bank1_NORSRAM(n) + (1 << 5)
FSMC_A6  = FSMC_Bank1_NORSRAM(n) + (1 << 6)
FSMC_A7  = FSMC_Bank1_NORSRAM(n) + (1 << 7)
FSMC_A8  = FSMC_Bank1_NORSRAM(n) + (1 << 8)
FSMC_A9  = FSMC_Bank1_NORSRAM(n) + (1 << 9)
FSMC_A10 = FSMC_Bank1_NORSRAM(n) + (1 << 10)
FSMC_A11 = FSMC_Bank1_NORSRAM(n) + (1 << 11)
FSMC_A12 = FSMC_Bank1_NORSRAM(n) + (1 << 12)
FSMC_A13 = FSMC_Bank1_NORSRAM(n) + (1 << 13)
FSMC_A14 = FSMC_Bank1_NORSRAM(n) + (1 << 14)
FSMC_A15 = FSMC_Bank1_NORSRAM(n) + (1 << 15)
FSMC_A16 = FSMC_Bank1_NORSRAM(n) + (1 << 16)
FSMC_A17 = FSMC_Bank1_NORSRAM(n) + (1 << 17)
FSMC_A18 = FSMC_Bank1_NORSRAM(n) + (1 << 18)
FSMC_A19 = FSMC_Bank1_NORSRAM(n) + (1 << 19)
FSMC_A20 = FSMC_Bank1_NORSRAM(n) + (1 << 20)
FSMC_A21 = FSMC_Bank1_NORSRAM(n) + (1 << 21)
FSMC_A22 = FSMC_Bank1_NORSRAM(n) + (1 << 22)
FSMC_A23 = FSMC_Bank1_NORSRAM(n) + (1 << 23)

16位Data FSMC_A(n)(寄存器/数据选择)脚
FSMC_A0  = FSMC_Bank1_NORSRAM(n) + (1 << 1)
FSMC_A1  = FSMC_Bank1_NORSRAM(n) + (1 << 2)
FSMC_A2  = FSMC_Bank1_NORSRAM(n) + (1 << 3)
FSMC_A3  = FSMC_Bank1_NORSRAM(n) + (1 << 4) 
FSMC_A4  = FSMC_Bank1_NORSRAM(n) + (1 << 5)
FSMC_A5  = FSMC_Bank1_NORSRAM(n) + (1 << 6)
FSMC_A6  = FSMC_Bank1_NORSRAM(n) + (1 << 7)
FSMC_A7  = FSMC_Bank1_NORSRAM(n) + (1 << 8)
FSMC_A8  = FSMC_Bank1_NORSRAM(n) + (1 << 9)
FSMC_A9  = FSMC_Bank1_NORSRAM(n) + (1 << 10)
FSMC_A10 = FSMC_Bank1_NORSRAM(n) + (1 << 11)
FSMC_A11 = FSMC_Bank1_NORSRAM(n) + (1 << 12)
FSMC_A12 = FSMC_Bank1_NORSRAM(n) + (1 << 13)
FSMC_A13 = FSMC_Bank1_NORSRAM(n) + (1 << 14)
FSMC_A14 = FSMC_Bank1_NORSRAM(n) + (1 << 15)
FSMC_A15 = FSMC_Bank1_NORSRAM(n) + (1 << 16)
FSMC_A16 = FSMC_Bank1_NORSRAM(n) + (1 << 17)
FSMC_A17 = FSMC_Bank1_NORSRAM(n) + (1 << 18)
FSMC_A18 = FSMC_Bank1_NORSRAM(n) + (1 << 19)
FSMC_A19 = FSMC_Bank1_NORSRAM(n) + (1 << 20)
FSMC_A20 = FSMC_Bank1_NORSRAM(n) + (1 << 21)
FSMC_A21 = FSMC_Bank1_NORSRAM(n) + (1 << 22)
FSMC_A22 = FSMC_Bank1_NORSRAM(n) + (1 << 23)
FSMC_A23 = FSMC_Bank1_NORSRAM(n) + (1 << 24)
...
#define      FSMC_Addr_ILI9341_DATA        ( ( uint32_t ) 0x60000000 | (1 << 24) )
...
void LCD_WR_REG(uint16_t regval)
{
    ...
    * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_CMD ) = regval;  //写入要写的寄存器序号
}
...
uint16_t LCD_RD_DATA(void)
{
    ...
    ram = * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA );
    return ram;
}
...
{
    * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_CMD ) = LCD_Reg;         //写入要写的寄存器序号
    * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA ) = LCD_RegValue;    //写入数据
}
...
{
    * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_CMD ) = lcddev.wramcmd;
}
...
{
    * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA ) = RGB_Code;        //写十六位GRAM
}
...
void LCD_DrawPoint(uint16_t x, uint16_t y)
{
    ...
    * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA )=POINT_COLOR;
}
...
void LCD_Fast_DrawPoint(uint16_t x, uint16_t y, uint16_t color)
{
    ...
    * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_CMD )=lcddev.wramcmd;
    * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA )=color;
}
...
void LCD_Fill(uint16_t sx,uint16_t sy,uint16_t ex,uint16_t ey,uint16_t color)
{
    ...
    for (i = sy; i <= ey; i++)
    {
        ...
        for (j = 0; j < xlen; j++)
        {
            * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA ) = color;   //设置光标位置
        }
    }
}
...
void LCD_Color_Fill(uint16_t sx, uint16_t sy, uint16_t ex, uint16_t ey, uint16_t *color)
{
    ...
    for (i = 0; i < height; i++)
    {
        ...
        for (j = 0; j < width; j++)
        {
            * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA )=color[i * width + j];  //写入数据
        }
    }
}
...
void LCD_printf(uint16_t x , uint16_t y ,uint8_t size_mode ,char *q,...)
{
	char formetBuff[48];
	va_list ap;
	va_start(ap,q);
	vsprintf(formetBuff,q,ap);
	va_end(ap);
	int s = sizeof(formetBuff);
	LCD_ShowString( x,  y,  8 * s ,  16, size_mode ,(uint8_t *) formetBuff);   //显示一个字符串,12/16字体
}
